...
test_configurations = [
    ...
    ("GET", "Upgrade", "HTTP/2.0", "invalid@ value# test$"),
    ("GET", "Via:", "1.1 proxy.example.com", "invalid@ value# test$"),
    ("GET", "X-Forwarded-Port", "443", "invalid@ value# test$"),
    ("GET", "X-Forwarded-Proto", "https", "invalid@ value# test$"),
    ("GET", "X-Real-IP", "127.0.0.1", "invalid@ value# test$"),
    ("GET", "Client-IP", "127.0.0.1", "invalid@ value# test$"),
    ("GET", "X-True-IP", "127.0.0.1", "invalid@ value# test$")
]
